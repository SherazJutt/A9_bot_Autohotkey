...
skip_cars:
    ...
    IniRead, iniLancer_to, %myinipath%, CarsSkip, Lancer
    ; Hellcat
    IniRead, iniHellcat, %myinipath%, CarsSkip, Hellcat
    IniRead, iniHellcat_to, %myinipath%, CarsSkip, Hellcat
    ; Peugeotsr1
    IniRead, iniPeugeotsr1, %myinipath%, CarsSkip, Peugeotsr1
    IniRead, iniPeugeotsr1_to, %myinipath%, CarsSkip, Peugeotsr1
    ; Lamborghinicountach25th
    IniRead, iniLamborghinicountach25th, %myinipath%, CarsSkip, Lamborghinicountach25th
    IniRead, iniLamborghinicountach25th_to, %myinipath%, CarsSkip, Lamborghinicountach25th
    ; Srt8
    IniRead, iniSrt8, %myinipath%, CarsSkip, Srt8
    IniRead, iniSrt8_to, %myinipath%, CarsSkip, Srt8
    ; Saleens1
    IniRead, iniSaleens1, %myinipath%, CarsSkip, Saleens1
    IniRead, iniSaleens1_to, %myinipath%, CarsSkip, Saleens1
    ; Ferrarimonzasp1
    IniRead, iniFerrarimonzasp1, %myinipath%, CarsSkip, Ferrarimonzasp1
    IniRead, iniFerrarimonzasp1_to, %myinipath%, CarsSkip, Ferrarimonzasp1
    ; Jaguarxesvproject
    IniRead, iniJaguarxesvproject, %myinipath%, CarsSkip, Jaguarxesvproject
    IniRead, iniJaguarxesvproject_to, %myinipath%, CarsSkip, Jaguarxesvproject
    ; Lamborghinimiura
    IniRead, iniLamborghinimiura, %myinipath%, CarsSkip, Lamborghinimiura
    IniRead, iniLamborghinimiura_to, %myinipath%, CarsSkip, Lamborghinimiura
    ; Bugattieb110
    IniRead, iniBugattieb110, %myinipath%, CarsSkip, Bugattieb110
    IniRead, iniBugattieb110_to, %myinipath%, CarsSkip, Bugattieb110
    ; Porsche911gscoupe
    IniRead, iniPorsche911gscoupe, %myinipath%, CarsSkip, Porsche911gscoupe
    IniRead, iniPorsche911gscoupe_to, %myinipath%, CarsSkip, Porsche911gscoupe
    ; Nissanr390
    IniRead, iniNissanr390, %myinipath%, CarsSkip, Nissanr390
    IniRead, iniNissanr390_to, %myinipath%, CarsSkip, Nissanr390
    ; Ferrarienzo
    IniRead, iniFerrarienzo, %myinipath%, CarsSkip, Ferrarienzo
    IniRead, iniFerrarienzo_to, %myinipath%, CarsSkip, Ferrarienzo
    ; Lamborghiniessenza
    IniRead, iniLamborghiniessenza, %myinipath%, CarsSkip, Lamborghiniessenza
    IniRead, iniLamborghiniessenza_to, %myinipath%, CarsSkip, Lamborghiniessenza
    ; Porschecarrera
    IniRead, iniPorschecarrera, %myinipath%, CarsSkip, Porschecarrera
    IniRead, iniPorschecarrera_to, %myinipath%, CarsSkip, Porschecarrera
    ; Vulkan
    IniRead, iniVulkan, %myinipath%, CarsSkip, Vulkan
    IniRead, iniVulkan_to, %myinipath%, CarsSkip, Vulkan
    ; Sennagtr
    IniRead, iniSennagtr, %myinipath%, CarsSkip, Sennagtr
    IniRead, iniSennagtr_to, %myinipath%, CarsSkip, Sennagtr
    ; Zondar
    IniRead, iniZondar, %myinipath%, CarsSkip, Zondar
    IniRead, iniZondar_to, %myinipath%, CarsSkip, Zondar
    ; Centenario
    IniRead, iniCentenario, %myinipath%, CarsSkip, Centenario
    IniRead, iniCentenario_to, %myinipath%, CarsSkip, Centenario
    ; RaesrTacheon
    IniRead, iniRaesrTacheon, %myinipath%, CarsSkip, RaesrTacheon
    IniRead, iniRaesrTacheon_to, %myinipath%, CarsSkip, RaesrTacheon
    ; Trion
    IniRead, iniTrion, %myinipath%, CarsSkip, Trion
    IniRead, iniTrion_to, %myinipath%, CarsSkip, Trion
    ; Naran
    IniRead, iniNaran, %myinipath%, CarsSkip, Naran
    IniRead, iniNaran_to, %myinipath%, CarsSkip, Naran
...
save_cars_skip:
    Gui, Submit, NoHide
    IniWrite, %iniLancer_to%, %myinipath%, CarsSkip,Lancer
    IniWrite, %iniHellcat_to%, %myinipath%, CarsSkip,Hellcat
    IniWrite, %iniPeugeotsr1_to%, %myinipath%, CarsSkip,Peugeotsr1
    IniWrite, %iniLamborghinicountach25th_to%, %myinipath%, CarsSkip,Lamborghinicountach25th
    IniWrite, %iniSrt8_to%, %myinipath%, CarsSkip,Srt8
    IniWrite, %iniSaleens1_to%, %myinipath%, CarsSkip,Saleens1
    IniWrite, %iniFerrarimonzasp1_to%, %myinipath%, CarsSkip,Ferrarimonzasp1
    IniWrite, %iniJaguarxesvproject_to%, %myinipath%, CarsSkip,Jaguarxesvproject
    IniWrite, %iniLamborghinimiura_to%, %myinipath%, CarsSkip,Lamborghinimiura
    IniWrite, %iniBugattieb110_to%, %myinipath%, CarsSkip,Bugattieb110
    IniWrite, %iniPorsche911gscoupe_to%, %myinipath%, CarsSkip,Porsche911gscoupe
    IniWrite, %iniNissanr390_to%, %myinipath%, CarsSkip,Nissanr390
    IniWrite, %iniFerrarienzo_to%, %myinipath%, CarsSkip,Ferrarienzo
    IniWrite, %iniLamborghiniessenza_to%, %myinipath%, CarsSkip,Lamborghiniessenza
    IniWrite, %iniPorschecarrera_to%, %myinipath%, CarsSkip,Porschecarrera
    IniWrite, %iniVulkan_to%, %myinipath%, CarsSkip,Vulkan
    IniWrite, %iniSennagtr_to%, %myinipath%, CarsSkip,Sennagtr
    IniWrite, %iniZondar_to%, %myinipath%, CarsSkip,Zondar
    IniWrite, %iniCentenario_to%, %myinipath%, CarsSkip,Centenario
    IniWrite, %iniRaesrTacheon_to%, %myinipath%, CarsSkip,RaesrTacheon
    IniWrite, %iniTrion_to%, %myinipath%, CarsSkip,Trion
    IniWrite, %iniNaran_to%, %myinipath%, CarsSkip,Naran
