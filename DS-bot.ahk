...
reveal_next:
    ...
    ; Text:="|<>*116$43.0DUz0z1U7UD0C0E3U3U700zllXlXUTsslslk0wQMwMs0CCASAQ3776D6CDnXX7X77tllXlXUwsslslkAQ8QMsE0C0S0Q0kDkTUT0s"
        ...
        start:
            ...
            Loop, 60{
                ...
                if (ok:=FindText(X, Y, 787, 42, 823, 80, 0, 0, Text))
                {
                    ...
                    Goto, script_start
                    ; MsgBox, token color check to verify home screen to break loop
                }
            }
